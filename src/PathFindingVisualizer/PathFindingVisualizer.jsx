        ...
        return (
            <>
                ...
                <div className="dropdown" style={{marginTop: "10px"}}>
                        <button className="btn btn-outline-dark dropdown-toggle" type="button" disabled={this.state.rendering} id="speedDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style={{marginRight:"5px", height: "30px", width: "150px" }}>
                            <p style={{marginTop: "-5px"}}>{`Speed: ${this.state.speed}`}</p>
                        </button>
                        <div className="dropdown-menu" aria-labelledby="speedDropdown">
                            <button type="button" className="dropdown-item" onClick={() => this.setSpeed('slow')}>slow</button>
                            <button type="button" className="dropdown-item" onClick={() => this.setSpeed('median')}>median</button>
                            <button type="button" className="dropdown-item" onClick={() => this.setSpeed('fast')}>fast</button>
                        </div>
                        <button
                        onClick={() => { 
                        ...
                        <p style={{marginTop: "-6px"}}>generate maze</p>
